...
class TwoFactorVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TwoFactorVerificationController controller =
        Get.isRegistered<TwoFactorVerificationController>()
        ? Get.find<TwoFactorVerificationController>()
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Premium Circular Shield/Key Icon
              Center(
                child: Container(
                  width: 90,
                  height: 90,
